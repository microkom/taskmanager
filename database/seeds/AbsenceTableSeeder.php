...
class AbsenceTableSeeder extends Seeder
{
     ...
     */
       private $arrayAbsences = [
        ...
        ["id" => 5, "employee_id" => 3, "start_date_time" => "2019/5/31 00:00:00", "end_date_time" => "2019/5/31 23:59:59" ],
        ["id" => 6, "employee_id" => 6, "start_date_time" => "2019/5/31 00:00:00", "end_date_time" => "2019/5/31 23:59:59"]
